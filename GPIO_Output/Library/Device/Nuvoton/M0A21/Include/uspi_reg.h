...
typedef struct
{
     ...
     * |        |          |0 = Master mode.
     * |        |          |1 = Slave mode.
     * |[1]     |SLV3WIRE  |Slave 3-wire Mode Selection
     ...
     * |        |          |Note: Master only.
     * |[3]     |AUTOSS    |Automatic Slave Select Function Enable
     ...
     * |[25:16] |SLVTOCNT  |Slave Mode Time-out Period
     ...
     * |        |          |Note: Slave only.
     * |[28]    |TXUDRPOL  |Transmit Under-run Data Polarity
     ...
     * |        |          |Note: It is cleared by software write 1 to this bit.
     * |        |          |Note: for Slave only.
     * |[6]     |SLVBEIF   |Slave Bit Count Error Interrupt Flag
     ...
     * |        |          |Note: for Slave only.
     * |[8]     |SSINAIF   |Slave Select Inactive Interrupt Flag
     ...
     * |        |          |Note: for Slave only.
     * |[9]     |SSACTIF   |Slave Select Active Interrupt Flag
