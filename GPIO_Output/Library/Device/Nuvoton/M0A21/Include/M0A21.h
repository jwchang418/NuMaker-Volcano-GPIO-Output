 ...
 * $Revision: 5 $
 * $Date: 20/06/22 4:08p $
 * @brief    M0A21 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  \mainpage NuMicro M0A21 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M0A21 MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
typedef enum IRQn
{
    ...
    GPIO_PCPD_IRQn            = 5,        /*!< GPIO_PCPD Interrupt                                  */
    ...
    CAN0_IRQn                 = 15,       /*!< CAN0 Interrupt                                       */
    USCI0_IRQn                = 22,       /*!< USCI0 Interrupt                                      */
    DAC0_IRQn                 = 24,       /*!< DAC0 Interrupt                                       */
    ACMP01_IRQn               = 25,       /*!< ACMP0/1 Interrupt                                    */
    PDMA_IRQn                 = 26,       /*!< PDMA Interrupt                                       */
    USCI1_IRQn                = 27,       /*!< USCI1 Interrupt                                      */
...
#include "system_M0A21.h"          /*!< M0A21 System                                    */
...
#define PA_BASE             (GPIO_BASE      + 0x0000)                   /*!< GPIO PA Base Address                           */
...
#define UART1_BASE          (APB1_BASE      + 0x71000)                  /*!< UART1 Base Address                             */

#define CAN0_BASE           (APB1_BASE      + 0xA0000)                  /*!< CAN0 Base Address                              */
...
#define DAC                 ((DAC_T *) DAC0_BASE)                       /*!< DAC Configuration Struct                         */
...
#define CAN                 ((CAN_T *) CAN0_BASE)                       /*!< CAN0 Configuration Struct                        */
//#define LIN                 ((LIN_T *) LIN0_BASE)                       /*!< LIN0 Configuration Struct                        */
...
#endif  /* end of #ifndef __M0A21_H__ */
